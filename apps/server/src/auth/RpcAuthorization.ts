...
export const RPC_REQUIRED_SCOPES = {
  ...
  [EXTENSIONS_WS_METHODS.getThreadSnapshot]: AuthOrchestrationReadScope,
  [EXTENSIONS_WS_METHODS.getPreviewSnapshot]: AuthOrchestrationReadScope,
  [EXTENSIONS_WS_METHODS.refreshThread]: AuthOrchestrationOperateScope,
  [EXTENSIONS_WS_METHODS.subscribeThread]: AuthOrchestrationReadScope,
