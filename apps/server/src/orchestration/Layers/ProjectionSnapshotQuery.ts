          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                mcpOverrides: row.mcpOverrides,
                extensionOverridesRevision: row.extensionOverridesRevision,
                deletedAt: row.deletedAt,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        skillOverrides: threadRow.value.skillOverrides,
        mcpOverrides: threadRow.value.mcpOverrides,
        extensionOverridesRevision: threadRow.value.extensionOverridesRevision,
